...
\todo[inline, color=edired]{Finish quantum sensing section}
\input{Sections/SpinPopulation.tex}
\todo[inline, color=edired]{Finish spin population section}
\input{Sections/ODMR.tex}
\todo[inline, color=edired]{Finish ODMR section}
