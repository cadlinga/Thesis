...
B_dict = {"magnitude": 50 * 10**-6, "theta": 0, "phi": 0}
...
def plotD(T):
    ...
    B_array = array(B_array) / 10**-3
    label = "D @ " + str(T) + "K"
    pyplot.plot(B_array, D_array, c="k", alpha=0.3, linestyle="dashed")
...
makePlot(300, B_dict, E_dict, "black", 0.8, label="E = 0, T=300")
# Warmer
...
#
E_dict = {"magnitude": 50000, "theta": pi / 2, "phi": 0}
makePlot(300, B_dict, E_dict, "blue", 0.8, "E > 0, T=300")
#

E_dict = {"magnitude": 50000, "theta": pi / 2, "phi": 0}
makePlot(200, B_dict, E_dict, "purple", 0.8, "E > 0, T=200")
...
pyplot.savefig("../figures/EFieldPerpTemp")
